...
public class GuardDevice extends BaseGuardDevice<GuardDevice> {
	...
	public Page<GuardDevice> queryDevices(Integer pageNo, Integer pageRow, Map<String, String> queryparam) {
		List<Object> params=new ArrayList<>();
		StringBuilder selectsql=new StringBuilder();
		selectsql.append("select *");
		StringBuilder formsql=new StringBuilder();
		formsql.append(" from guard_device device");
		formsql.append(" where 1=1");
		if (StringUitils.isNotBlank(queryparam.get("state"))) {
			formsql.append(" and plot.state=?");
			params.add(queryparam.get("state"));
		}
